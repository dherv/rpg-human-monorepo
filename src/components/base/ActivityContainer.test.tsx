...
describe('ActivityContainer Component', () => {
  ...
  it.skip('should add an activiy', async () => {
  ...
  it.skip('should display the activity on click', async () => {
    userEvent.click(await screen.findByText('skateboard'))
    expect(await screen.findByText(/update activiy - skateboard/)).toBeDefined()
  })
})
